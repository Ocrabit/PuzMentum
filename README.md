...
PuzMentum is a momentum-based puzzle game built around a simple core idea: you control a rolling ball that leaves behind after-images. These after-images trigger different gimmicks throughout each level, and by placing them strategically, you can unlock new areas, activate switches, and reach keys that allow you to progress.
